...
- **Learning didn't rescue it.** An RL policy with access to entropy and confidence
  ...
  profile — itself evidence that best-first under a fixed budget is close to optimal
  for this workload.
...
not a static strawman. In our experiments, across entropy-based, coverage-based,
